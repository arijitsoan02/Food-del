    ...
    <div className='login-popup'>
      <form onSubmit={onLogin} className="login-popup-container">
        ...
        <div className="login-popup-input">
          {currState === "Log in" ? <></> : <input name='name' onChange={onChangeHandler} value={data.name} type='text' placeholder='Your name' required></input>}
        ...
        {currState === "Log in" ?
          ...
          <p>Alredy have account? <span onClick={() => setCurrState("Log in")}>Log in here</span></p>}
      </form>
    </div>
  )
}
